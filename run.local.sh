...
# https://api.fyndx0.de/service/___/administrator/communication/v1.0/log'
export POINTBLANK_MAIN_URL=https://api.${FYND_PLATFORM_DOMAIN}/service/___/administrator/communication/
