...
export SURESHOT_ADMIN_URL=https://api.${FYND_PLATFORM_DOMAIN}/service/___/administrator/webhook/
...
export FRENZY_PLTM_URL=https://api.${FYND_PLATFORM_DOMAIN}/service/platform/insights/
