...
export HIGHBROW_MAIN_URL=https://api.${FYND_PLATFORM_DOMAIN}/service/___/administrator/lead
export HIGHBROW_MAIN_SVC=https://api.${FYND_PLATFORM_DOMAIN}/service/___/administrator/lead
