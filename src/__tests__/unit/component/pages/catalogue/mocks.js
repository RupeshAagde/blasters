export default {
    ...
    variants : [{"display":"Additional Colors","priority":1,"uid":2,
    ...
    choicesResponse: {"data":[{"key":"text","value":"Text"},
    {"key":"image","value":"Image"},
    {"key":"color","value":"Color"}],
    "type":"variants"},
    attributeMasterResponse: {"data":[{"meta":{"enriched":false,"mandatory_details":{"l3_keys":[]}},
    ...
    "description":"","tags":[],"schema":{"multi":false,"range":{},
    "mandatory":false,"enum":[],"type":"str"},"details":{"displayType":"details"},
