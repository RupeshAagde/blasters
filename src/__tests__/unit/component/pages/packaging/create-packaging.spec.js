...
describe('Category packaging home', () => {
    ...
    it('should check for class name of save button', async () => {
        ...
        expect(wrapper.find('#save-packaging-btn').attributes().class).toBe(
            'add-packaging-button opaque-custom'
        );
    ...
    it('should check for modal', async () => {
        ...
        expect(
            ...
            'Packaging has been successfully added to the list'.replace(
                /\s/g,
                ''
            )
        );
