...
import index from '@/pages/tickets/configuration/kapture-integration/index.vue';
...
describe('index Page', () => {
    ...
    it('Get Kapture Details', async () => {
        const router = new VueRouter({
            routes: [
                { path: '/administrator/support/configuration/kapture-integration/index', component: index }
            ]
        })
