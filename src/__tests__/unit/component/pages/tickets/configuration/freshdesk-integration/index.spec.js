...
import index from '@/pages/tickets/configuration/freshdesk-integration/index.vue';
...
describe('index Page', () => {
    ...
    it('Get freshdesk Details', async () => {
        const router = new VueRouter({
            routes: [
                { path: '/administrator/support/configuration/freshdesk-integration/index', component: index }
            ]
        })
    ...
    //         ]
    //     })
    //     router.push('/administrator/support/configuration/freshdesk-integration/index');
    //     const wrapper = mount(index, {
    //         localVue,
    //         router
    //     })
