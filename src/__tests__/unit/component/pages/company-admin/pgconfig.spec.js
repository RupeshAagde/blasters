...
describe('Mounted PG review component ', () => {
  ...
  it('Get pg detail page info. successfully', async () => {
    ...
    mock.onGet(URLS.FETCH_COD_CONFIG({ companyId: '1', app_id: '000000000000000000000001' }))
    .reply(200, MOCK_DATA.getcod);

    mock.onGet(URLS.FETCH_REVIEW_LIST({ companyId: '1', app_id: '000000000000000000000001' }, "true"))
    .reply(200, MOCK_DATA.getpg);
   
    mock.onPost(URLS.FETCH_COD_CONFIG({ companyId: '1', app_id: '000000000000000000000001' }))
    .reply(200, MOCK_DATA.getcod);
    mock.onPost(URLS.PG_REVIEWED({ companyId: '1', app_id: '000000000000000000000001', paymentId: 45, email: "omanshlavania@gofynd.com" }))
    .reply(200, MOCK_DATA.postpg);
  ...
  it('Post review', async () => {
    ...
    wrapper.vm.password = 'dummy';
		const approveButton = wrapper.find('#approve');
    approveButton.vm.$emit('click')
    await flushPromises();
