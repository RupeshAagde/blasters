    ...
    <div class="permission-div">
        ...
        >
            <div
                ...
                class="main-div"
                :class="{ 'disable-div': currentRole != 'custom' || isOrganisationUser}"
            >
                <nitrozen-checkbox
                    :checkboxValue="item.key"
                    v-model="checkedPermissions"
                    :disabled="currentRole != 'custom' || isOrganisationUser"
                >
                    <div class="access">
                        <span class="title"
                            >{{ item.title }}
...
export default {
    ...
    //     this.checkedPermissions = this.currentPermissions;
    // },
    watch: {
        currentRole() {
    ...
    methods: {
        selectPermission(key) {
            // let index = this.checkedPermissions.findIndex(ele => {
            //     return ele == key;
            // });
            // if (index == -1) {
            //     this.checkedPermissions.push(key);
            // } else {
        ...
        setPermissionData() {
            if (this.currentRole != 'custom') {
                ...
                console.log(data, 'set permission data');
