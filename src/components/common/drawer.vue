...
export default {
    ...
    methods: {
        ...
        handleMove(e) {
            ...
            if (valid) {
                ...
                if (this.direction == 'left') {
                    this.translate =
                        e.touches[0].pageX - this.element.offsetWidth;
                    if (this.translate < 0) {
        ...
        open() {
            this.translate = 0;
            this.element.style.transform =
                'translate3d(' + this.translate + ',0,0)';
        ...
        percentage(direction, gesture) {
            ...
            if (this.active && gesture == test[0]) {
                percentage =
                    100 -
                    Math.round(
                        (Math.abs(this.translate) / this.element.offsetWidth) *
                            100
                    );
            }
