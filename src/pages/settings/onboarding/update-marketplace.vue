        ...
        <div class="page-container" v-else>
            ...
            <div class="form-container">
                ...
                <div class="border-line">
                    ...
                    <div v-for="item in lineItems" :key="item.id"  class="hr-style">
                        <component-factory
                            :lineItem="item"
                            :parentState="true"
                            ref="getData"
            ...
            if (this.applicationId) {
                this.fetchData().then((storedConfig) => {
                    ...
                    this.lineItems = [
                        ...
                        this.getBrandComponent(storedConfig.validation.brand),
            ...
            let updateData = {
                ...
                validation: {
                    company: {
                        ...
                        bank_ac_required:
                            formData.company.bank_account_required,
                    },
                    brand: {
        ...
        getBrandComponent(brandDetails) {
            return getGroupComponent('brand', 'Brand', [
                getRadioGroup(
                    ...
                    [
                        getRadioComponent('verified', 'Only allow verified brands', []),
        ...
        getLocationComponent(locationDetails) {
            return getGroupComponent('location', 'Location', [
                getRadioGroup(
                    ...
                    [
                        getRadioComponent('verified', 'Only allow verified locations', []),
        ...
        getProductComponent(productDetails) {
            return getGroupComponent('product', 'Product', [
                getRadioGroup(
                    ...
                    [
                        getRadioComponent('verified', 'Only allow verified products', []),
