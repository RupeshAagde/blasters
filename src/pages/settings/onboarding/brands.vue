        ...
        saveForm() {
            ...
            let updateData = {
                configuration: {
                    auto_verify: {
                        enabled:
                            safeAccess(formData, 'auto_verify.enabled') || false
                    },
                    documents: {
                        enabled:
                            safeAccess(formData, 'brand_documents.enabled') ||
                            false,
                        mandatory: safeAccess(
                            formData,
                            'brand_documents.mandatory'
                        ),
                        documents: {
                            authorization_letter: safeAccess(
                                formData,
                                'brand_documents.documents.authorization_letter'
                            ),
                            trademark_certificate: safeAccess(
                                formData,
                                'brand_documents.documents.trademark_certificate'
                            ),
                            trademark_certificate_application: safeAccess(
                                formData,
                                'brand_documents.documents.trademark_certificate_application'
                            ),
                            other: safeAccess(
                                formData,
                                'brand_documents.documents.other'
                            )
                        }
                    },
                    brand_logo: {
                        dimensions: {
                            width: safeAccess(
                                formData,
                                'brand_logo.dimensions_header.dimensions.from'
                            ),
                            height: safeAccess(
                                formData,
                                'brand_logo.dimensions_header.dimensions.to'
                            )
                        },
                        fixed_aspect_ratio:
                            safeAccess(
                                formData,
                                'brand_logo.brand_logo_aspect_ratio'
                            ) || false
                    },
                    brand_landscape_banner: {
                        dimensions: {
                            width: safeAccess(
                                formData,
                                'brand_landscape_banner.dimensions_header.dimensions.from'
                            ),
                            height: safeAccess(
                                formData,
                                'brand_landscape_banner.dimensions_header.dimensions.to'
                            )
                        },
                        fixed_aspect_ratio:
                            safeAccess(
                                formData,
                                'brand_landscape_banner.brand_landscape_banner_aspect_ratio'
                            ) || false
                    },
                    brand_portrait_banner: {
                        dimensions: {
                            width: safeAccess(
                                formData,
                                'brand_portrait_banner.dimensions_header.dimensions.from'
                            ),
                            height: safeAccess(
                                formData,
                                'brand_portrait_banner.dimensions_header.dimensions.to'
                            )
                        },
                        fixed_aspect_ratio:
                            safeAccess(
                                formData,
                                'brand_portrait_banner.brand_portrait_banner_aspect_ratio'
                            ) || false
                    }
                }
            };
                ...
                [
                    ...
                    getGroupComponent('documents', 'Documents', [
                        getCheckboxComponent(
                            ...
                            safeAccess(
                                apiConfig,
                                'documents.documents.authorization_letter'
                            )
                        ),
                        getCheckboxComponent(
                            ...
                            safeAccess(
                                apiConfig,
                                'documents.documents.trademark_certificate'
                            )
                        ),
                        getCheckboxComponent(
                            ...
                            safeAccess(
                                apiConfig,
                                'documents.documents.trademark_certificate_application'
                            )
                        ),
                        getCheckboxComponent(
                            'other',
                            'Other',
                            safeAccess(apiConfig, 'documents.documents.other')
                        )
                    ])
                ]
            );
        ...
        getBrandLogoComponent(apiConfig) {
            return getGroupComponent('brand_logo', 'Brand Logo', [
                ...this.getImageComponent(
                    'brand_logo',
                    safeAccess(apiConfig, 'brand_logo')
                )
            ]);
        },
        getBrandLandscapeBannerComponent(apiConfig) {
            return getGroupComponent(
                ...
                [
                    ...this.getImageComponent(
                        'brand_landscape_banner',
                        safeAccess(apiConfig, 'brand_landscape_banner')
                    )
                ]
            );
        },
        getBrandPortraitBannerComponent(apiConfig) {
            return getGroupComponent(
                ...
                [
                    ...this.getImageComponent(
                        'brand_portrait_banner',
                        safeAccess(apiConfig, 'brand_portrait_banner')
                    )
                ]
            );
        },
