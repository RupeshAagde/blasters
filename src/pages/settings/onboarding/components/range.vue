...
export default {
    ...
    data() {
        return {
            ...
            fromPlaceholder: safeAccess(this.lineItem, 'additionalParams.fromPlaceholder') || 'From',
            toPlaceholder: safeAccess(this.lineItem, 'additionalParams.toPlaceholder') || 'To',
            minValue: safeAccess(this.lineItem, 'additionalParams.minValue') || 0,
            fromAlert: '',
            toAlert: '',
        };
    },
