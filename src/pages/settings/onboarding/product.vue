    ...
    methods: {
                ...
                configuration: {
                    product_update: {
                        restricted_gategory_rules_applicable:
                            safeAccess(
                                formData,
                                'product_update.restricted_gategory_rules_applicable'
                            ) || false,
                        gst_exemption_applicable:
                            safeAccess(
                                formData,
                                'product_update.gst_exemption_applicable'
                            ) || false,
                        product_verification_media_mandatory:
                            safeAccess(
                                formData,
                                'product_update.product_verification_media_mandatory'
                            ) || false
                    },
                    auto_verify: {
                        enabled:
                    ...
                    national_pricing: {
                        enabled:
                            safeAccess(formData, 'national_pricing.enabled') ||
                            false
                    },
                    return_config: {
                        enabled:
                            safeAccess(formData, 'return_config.enabled') ||
                            false
                    }
        ...
        getAutoVerifyComponent(apiConfig) {
            return getToggleComponent(
                ...
                [getBadge('note', 'Note: Product must be in active state')]
            );
        },
        ...
        getProductUpdateComponent(apiConfig) {
            return getGroupComponent('product_update', 'Add and Edit Product', [
                getCheckboxComponent(
                    'restricted_gategory_rules_applicable',
