...
export default {
    ...
    methods: {
            ...
            let updateData = {
                configuration: {
                    ...
                    sales_channel: {
                        ...
                        channels: safeAccess(formData, 'sales_channel.channels')
                    },
                    referral_code: {
                        enabled:
                    ...
                    optin_application: {
                        ...
                        applications: this.getOptInApplicationsSaveRequest(
                            formData
                        )
                    }
                }
        ...
        getOptInComponent(apiConfig) {
            return [
                getGroupComponent('opt_in', 'Auto Opt-in Application', [
                    getGroupComponent(
                        'applications',
                        'Application',
                        this.availableOptInApplications.map(
                            (optInApplication) => {
                                return getToggleComponent(
                                    optInApplication.id,
                                    ...
                                    safeAccess(
                                        apiConfig,
                                        `optin_application.applications.${optInApplication.id}`
                                    ) || false,
                                    undefined,
