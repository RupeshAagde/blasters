    ...
    <div class="blaster-list-card-container" @click="onClick" v-if="extension">
        ...
        <div class="card-content-section">
            ...
            <div class="card-content-line-2">
                Requested By: {{ extension.contact_info.review_notification_email }} on
                {{ toDateTimeString(extension.created_at) }} (
                {{ extension.organization_name }} )
            </div>
            <div
                class="card-content-line-3"
                v-if="extension.current_status !== 'pending'"
            >
                <span v-if="extension.current_status === 'published'"
                    >Published</span
                >
                <span v-if="extension.current_status === 'rejected'"
                    >Rejected</span
                >
        ...
        <div class="card-badge-section">
            ...
            <nitrozen-badge
                v-if="extension.current_status === 'rejected'"
                state="error"
            >
                Rejected
            </nitrozen-badge>
            <nitrozen-badge
                v-if="extension.current_status === 'published'"
                state="success"
            >
                Published
            </nitrozen-badge>
