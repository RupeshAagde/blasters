            ...
            <div class="container">
                <div class="stepper-container">
                    <div
                        ...
                        "
                        class="stepper-block"
                        @click="switchComp('Category_Mapping')"
                    >
                        <div
...
export default {
    ...
    data() {
        return {
            ...
            allowToAddTickets: true,
            allowToShowListings: true,
            webhookUrl: '',
            baseUrl: '',
            createTicketApikey: '',
            categoryData: [],
    ...
    methods: {
        setPageData(response) {
            this.default_Integration_ID = response.data._id
                ? response.data._id
                : '';
            this.createTicketApikey = response.data.create_ticket_apikey
            ...
            this.categoryData = response.data.category_data.list
